...
function capabilitiesFrom(source) {
  ...
  return {
    ...
    maxActiveBusFxSlots: positiveInteger(source, "maxActiveBusFxSlots"),
    maxActiveGlobalFxSlots: positiveInteger(source, "maxActiveGlobalFxSlots"),
...
const content = `// Generated by tools/generate-platform-capabilities.mjs from resources/platform-capabilities.json.
// Do not edit by hand.
