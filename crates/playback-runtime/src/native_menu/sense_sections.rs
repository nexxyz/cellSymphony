use super::{
    ...
    slot_option_selected, NativeMenuAction, NativeMenuItem, NativeSensePartConfig,
};

pub(super) fn scanning_group(
    prefix: &str,
    sense: &NativeSensePartConfig,
...
pub(super) fn note_mapping_group(prefix: &str, sense: &NativeSensePartConfig) -> NativeMenuItem {
    group(
        "Note Mapping",
        vec![
            number_item(
