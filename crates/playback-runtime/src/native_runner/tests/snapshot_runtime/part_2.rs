...
#[test]
pub(crate) fn transport_tick_advances_multiple_configured_parts() {
...
#[test]
pub(crate) fn inactive_part_transport_tick_applies_param_modulation() {
    let mut runner = NativeRunner::new(NativeRunnerConfig {
        behavior_id: "sequencer".into(),
        ..NativeRunnerConfig::default()
    })
...
#[test]
pub(crate) fn sequencer_grid_state_is_serialized_and_rehydrated_for_all_parts() {
    let mut runner = NativeRunner::new(NativeRunnerConfig {
        behavior_id: "sequencer".into(),
        ..NativeRunnerConfig::default()
    })
