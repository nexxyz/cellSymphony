...
#[test]
pub(crate) fn part_and_bus_names_round_trip_with_auto_name_flags() {
...
#[test]
pub(crate) fn native_text_row_edits_part_name_and_clears_auto_name() {
    let mut runner = NativeRunner::new(NativeRunnerConfig::default()).unwrap();
...
#[test]
pub(crate) fn auto_named_part_renames_when_behavior_changes_to_none() {
    let mut runner = NativeRunner::new(NativeRunnerConfig::default()).unwrap();
...
#[test]
pub(crate) fn auto_named_part_renames_after_toggling_auto_name_off_and_on() {
    let mut runner = NativeRunner::new(NativeRunnerConfig::default()).unwrap();
