...
#[test]
pub(crate) fn sense_value_lanes_load_into_runner_and_menu_curve_edits_apply() {
...
#[test]
pub(crate) fn assignment_mode_wins_over_fn_part_navigation_and_autosaves() {
    let mut runner = NativeRunner::new(NativeRunnerConfig::default()).unwrap();
...
#[test]
pub(crate) fn dance_mix_grid_edit_autosaves_persistent_volume_change() {
    let mut runner = NativeRunner::new(NativeRunnerConfig::default()).unwrap();
    runner.auto_save_default = true;
...
#[test]
pub(crate) fn dance_xy_touch_persists_and_release_behavior_matches_config() {
    let mut runner = NativeRunner::new(NativeRunnerConfig::default()).unwrap();
...
#[test]
pub(crate) fn dance_xy_overlay_marks_physical_touch_with_inverted_modulation() {
    let mut runner = NativeRunner::new(NativeRunnerConfig::default()).unwrap();
    runner.active_dance_mode = "xy".into();
    runner.xy_invert_x = true;
...
#[test]
pub(crate) fn dance_xy_reset_center_overlay_returns_to_center() {
    let mut runner = NativeRunner::new(NativeRunnerConfig::default()).unwrap();
    runner.active_dance_mode = "xy".into();
    runner.xy_release = "reset-center".into();
