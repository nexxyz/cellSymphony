...
pub use platform_capabilities::{
    PlatformCapabilities, AUX_ENCODER_COUNT, BUS_COUNT, GLOBAL_FX_SLOT_COUNT, INSTRUMENT_COUNT,
    MAX_ACTIVE_BUS_FX_SLOTS, MAX_ACTIVE_GLOBAL_FX_SLOTS, OLED_HEIGHT, OLED_WIDTH,
    PAN_POSITION_COUNT, PART_COUNT, PLATFORM_CAPABILITIES, SAMPLE_SLOT_COUNT, SCAN_SECTION_COUNTS,
